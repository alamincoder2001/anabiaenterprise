...
class Products extends CI_Controller
{
    ...
    public function addProduct()
    {
        ...
        try {
            ...
            $product['is_imei']          = $productObj->is_imei == true ? 'true' : 'false';
            $product['status']           = 'a';
    ...
    public function getIMEIByProd()
    {
        ...
        $imeis = $this->db->query("SELECT sl.*,prod.Product_Name
                    ...
                    WHERE ps_prod_id='$prod_id' AND ps_brunch_id=" . $BRANCHid . " AND ps_p_r_status<>'yes' AND   (  ps_s_status IS NULL OR ps_s_status<>'yes'   OR ps_s_r_status='yes')")->result();
